...
`docs/harness.md` is the model the code is built on — ownership is exclusive,
reach is not. Read it before changing `agents.rs`, `annotations.rs`, or
anything that draws the Reach column.
