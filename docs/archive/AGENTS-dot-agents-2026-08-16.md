<!-- Archived 2026-08-16. This was .agents/AGENTS.md ("Project-Scoped Rules"), an older sibling of the root AGENTS.md; its Verification-integrity items are captured in .claude/rules/verification.md and coding-guardrails.md. Kept verbatim for the record. -->
